...
transcriptome_reference=raw_input('\nWrite the path for the reference transcriptome: ')		
reference_ID=raw_input('\nWrite the reference transcriptome identifier: ') 			 # ID = ('Cucsa')
...
# Opening reference transcriptome
list_isotigs_ref_genome=list_isotig(transcriptome_reference)
dictionari_ref_transcriptome=isotigs_with_seq(transcriptome_reference)
for isotig in list_isotigs_ref_genome:
	all_transcriptomes.write(format_fasta(reference_ID+'_'+isotig,dictionari_ref_transcriptome[isotig]))

file_reference = open('all_transcriptomes.fasta')
